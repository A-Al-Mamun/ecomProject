				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+880) 131010 7526" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+880) 131010 7526</a>
								</li>
							</ul>
						</div>
						<div class="topbar-menu right-menu">
							<ul>
								...
								<li class="menu-item menu-item-has-children parent" >
									...
									@if(Route::has('login'))
										@auth
											@if(Auth::user()->utype === 'ADM')  <!--Auth directive-->
												<!-- Admin -->
												<li class="menu-item menu-item-has-children parent" >
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><span style="color:blue; font-weight:bold; text-transform:uppercase; font-size:40px">Eshop</span></a>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Mirpur-2, Dhaka, Bangladesh</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+880) 131010 7526 - (+880) 13090 68352</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+880) 131010 7526 - (+880) 13090 68352</b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 CSE Final Project (Intake 30 & 25). All rights reserved</p>
					</div>
